module des.isys.neiro.layer.structure;

import std.traits;
import std.conv;

import des.isys.neiro.func;
import des.isys.neiro.neiron;
import des.isys.neiro.layer.neiron;
...
{
    import des.isys.neiro.layer.rand;
    T lim, gap;
