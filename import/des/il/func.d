...
if( isIntegral!T )
{
    ...
    alias Reg = Region!(N,CoordType);
    alias SV = SizeVector!N;
    ...
    foreach( i; 0 .. count )
    {
        auto lccrd = CoordVector!N( getCoord( crop.size, i ) );
...
unittest 
{
    ...
    auto orig = Image2( [5,5], DataType.UBYTE, 1, data );
    ...
    auto imv2 = Image2( [3,3], DataType.UBYTE, 1, datav2 );
    ...
    auto imv6 = Image2( [4,4], DataType.UBYTE, 1, datav6 );
    assert( imCopy( orig, iRegion2( 2, 2, 4, 4 ) ) == imv6 );
}

/// paste in image other image
void imPaste(size_t N,V)( ref Image!N img, in V pos, in Image!N pim )
...
in { assert( K < N ); } body
{
    auto ret = Image!(N-1)( removeStat( img.size, K ), img.info );
...
unittest
{
    ...
    auto img = Image3( [3,2,2], info, img_data );
    auto id2l0 = Image2( [3,2], info, d2l0 );
    auto id2l1 = Image2( [3,2], info, d2l1 );
    auto id1l0 = Image2( [3,2], info, d1l0 );
    auto id1l1 = Image2( [3,2], info, d1l1 );
    auto id0l0 = Image2( [2,2], info, d0l0 );
    auto id0l1 = Image2( [2,2], info, d0l1 );
